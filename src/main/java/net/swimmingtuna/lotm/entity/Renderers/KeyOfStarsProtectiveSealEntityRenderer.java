...
public class KeyOfStarsProtectiveSealEntityRenderer extends EntityRenderer<KeyOfStarsProtectiveSealEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(LOTM.MOD_ID, "textures/entity/protective_seal.png");

    public KeyOfStarsProtectiveSealEntityRenderer(EntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void render(KeyOfStarsProtectiveSealEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
        poseStack.pushPose();
    ...
    private void renderFace(VertexConsumer vertexConsumer, Matrix4f matrix, float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float x4, float y4, float z4, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(KeyOfStarsProtectiveSealEntity entity) {
        return new ResourceLocation(LOTM.MOD_ID, "textures/entity/protective_seal.png");
    }
    ...
    private static final RenderType CUSTOM_RENDER_TYPE = RenderType.create(
            ...
            RenderType.CompositeState.builder()
                    ...
                    .setTextureState(new RenderStateShard.TextureStateShard(
                            new ResourceLocation(LOTM.MOD_ID, "textures/entity/protective_seal.png"), false, false))
