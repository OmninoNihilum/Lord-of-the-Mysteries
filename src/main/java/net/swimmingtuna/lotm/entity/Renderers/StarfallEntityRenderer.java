...
public class StarfallEntityRenderer extends EntityRenderer<StarfallEntity> {
    ...
    // Create a render type similar to ColoredBoxEntity but for solid rendering
    ...
    private void addVertex(VertexConsumer consumer, Matrix4f matrix, Matrix3f normalMatrix,
        ...
        consumer.vertex(matrix, x, y, z)
                .color(color.r, color.g, color.b, 1.0f) // Now using floats with texture-based rendering
                .uv(u, v) // Proper UV coordinates
