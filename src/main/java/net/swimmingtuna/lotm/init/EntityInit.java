...
public class EntityInit {
    ...
    public static final RegistryObject<EntityType<BlackHoleEntity>> BLACK_HOLE_ENTITY =
            ENTITIES.register("black_hole_entity", () -> EntityType.Builder.<BlackHoleEntity>of(BlackHoleEntity::new, MobCategory.MISC)
                    .sized(5.0f,5.0f).clientTrackingRange(400).build(new ResourceLocation(LOTM.MOD_ID, "black_hole_entity").toString()));
    public static final RegistryObject<EntityType<BlackHoleOuterGlowEntity>> BLACK_HOLE_GLOW_ENTITY =
            ENTITIES.register("black_hole_glow_entity", () -> EntityType.Builder.<BlackHoleOuterGlowEntity>of(BlackHoleOuterGlowEntity::new, MobCategory.MISC)
                    .sized(5.0f,5.0f).clientTrackingRange(400).build(new ResourceLocation(LOTM.MOD_ID, "black_hole_glow_entity").toString()));
