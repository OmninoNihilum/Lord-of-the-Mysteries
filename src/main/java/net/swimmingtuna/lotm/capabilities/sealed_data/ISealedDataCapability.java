...
public interface ISealedDataCapability {
    ...
    HashMap<UUID, String> sealsCreatorsNames();                                     //<Seal UUID, Creator name> Seal Creator name
    ...
    HashMap<UUID, SEAL_TYPES> sealsTypes();                                         //<Seal UUID, Seal Type> The type of Seal, useful when a Seal needs to play a custom method when its over

    void setCreator(UUID sealUUID, UUID creator);                                   //Sets the Seal Creator
    void setCreatorName(UUID sealUUID, String creatorName);                         //Sets the Seal Creator name
    ...
    void setSealType(UUID sealUUID, SEAL_TYPES sealType);                           //Sets the Seal type
