...
public record ClientRecipiesJEISyncS2C(Map<ItemStack, BeyonderRecipeData.RecipeIngredients> beyonderRecipes) {

    public ClientRecipiesJEISyncS2C(FriendlyByteBuf buf) {
        // key: ItemStack
    ...
    public static void encode(ClientRecipiesJEISyncS2C packet, FriendlyByteBuf buf) {
        buf.writeMap(
    ...
    public static void handle(ClientRecipiesJEISyncS2C packet, Supplier<NetworkEvent.Context> ctx) {
        ctx.get().enqueueWork(() -> {
    ...
    public static ClientRecipiesJEISyncS2C decode(FriendlyByteBuf buf) {
        Map<ItemStack, BeyonderRecipeData.RecipeIngredients> recipes = buf.readMap(
                FriendlyByteBuf::readItem, // key: ItemStack
                BeyonderRecipeData.RecipeIngredients::fromNetwork // value: RecipeIngredients
        );
        return new ClientRecipiesJEISyncS2C(recipes);
    }
}
